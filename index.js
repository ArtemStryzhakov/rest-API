...
const widgets = [ // Read 8-12 defineerivad widgets nimelise massiivi, millel on 3 liiget, mis on objektid, millel on 3 atribuuti: id, name ja price
    { id: 1, name: "Erik", price: 29.99 },
    { id: 2, name: "Vantus", price: 26.99 },
    { id: 3, name: "Genadi", price: 59.99 },
    { id: 3, name: "Murzik", price: 74.99 },
]
...
app.post('/widgets', (req, res) => { // Read 26-28 kontrollivad, et päringul oleks kõik kohustuslikud parameetrid uue vidina lisamiseks
